...
class VehicleController():
    ...
    def set_steering(self, steering_value):
        self.max_steer = steering_value
    
    def set_throttle(self, throttle_value):
        self.max_throt = throttle_value
    ...
    def change_lateral_controller(self,Kv, Ks, dt ,offset ):
        """Changes the parameters of the StanleyLateralController"""
        print("Valore di offset: ", offset)
        self._lat_controller.change_parameters(Kv, Ks, dt ,offset)
...
class StanleyLateralController():
    ...
    def get_all_parameters(self):
       return self._kv , self._ks , self._offset
    ...
    def change_parameters(self, Kv, Ks, dt , offset):
        ...
        print("Offset nella change parameters: ", self._offset)
